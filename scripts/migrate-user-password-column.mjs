/**
 * Add passwordHash column to User table on Turso (idempotent).
 * Run: node scripts/migrate-user-password-column.mjs
 */
...
try {
  await db.execute(`ALTER TABLE User ADD COLUMN passwordHash TEXT`)
