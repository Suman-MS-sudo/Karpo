// Plain data + presentational icon components — deliberately NOT a client
// component, so Server Components (e.g. profile pages) can import and use
// these arrays directly. Importing them from a "use client" file instead
// wraps every export in a client-reference proxy, breaking plain array
// methods like .filter()/.map() when called during server rendering.
...
// ── Social platform configurations (for the share button) ──────────────────
