...
import { ProhibitedContentPolicyContent, PROHIBITED_CONTENT_SECTIONS as SECTIONS, PROHIBITED_CONTENT_LAST_UPDATED as LAST_UPDATED } from "@/components/legal/ProhibitedContentPolicyContent"

export const metadata = {
  title: "Prohibited Content Policy",
  description: "What may not be listed, posted or shared on Korpo.",
}
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#1E3A5F] via-[#1E3A5F] to-[#2E86AB] text-white py-16 lg:py-20">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight">
            Prohibited Content, Goods &amp; Services
          </h1>
      ...
      <section className="py-14 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-3 legal-content">
            <ProhibitedContentPolicyContent />
          </div>
        </div>
      </section>
